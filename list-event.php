...
<body>
  ...
  <hr>
    ...
    <thead>
      ...
      <th bgcolor="af8269" style="color:#f5f5f5;">Event Name</th>
      <th bgcolor="af8269" style="color:#f5f5f5;">Date</th>
      <th bgcolor="af8269" style="color:#f5f5f5;">Promoter</th>
    ...
    <tbody>
        ...
        while($events = mysqli_fetch_array($query)){
            ...
            echo "<td>".$events['promoter']."</td>";

            echo "<td>";
            echo "<a href='form-edit-event.php?id=".$events['id']."'>Edit</a> | ";
            echo "<a href='hapus-event.php?id=".$events['id']."'>Hapus</a>";
            echo "</td>";
